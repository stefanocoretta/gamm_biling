...
gam_2_preds <- predict_gam(
  ...
  # Need to pick a single value for excluded terms due to limitations of mgcv
  # Any value will work. Since the term is excluded, picking a specific value
...
gam_3_preds <- predict_gam(gam_3, exclude_terms = "s(timep,subj)", values = c(subj = "es_3"))
gam_3_preds
```
