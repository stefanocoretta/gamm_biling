...
Before looking at the summary of the `gam_1` model, we plot the predicted effect of proficiency. For this, we will use the tidygam package, which provides users with utility functions that make extracting and plotting predictions from GAMs more accessible.
