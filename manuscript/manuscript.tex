...
\pandocbounded{\includegraphics[keepaspectratio]{manuscript_files/figure-pdf/fig-dat1-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{manuscript_files/figure-pdf/fig-gam-1-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{manuscript_files/figure-pdf/fig-d1-dag-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{manuscript_files/figure-pdf/fig-d1-dag-2.pdf}}
...
\NormalTok{  gam\_2, }\AttributeTok{length\_out =} \DecValTok{25}\NormalTok{,}
  ...
  \CommentTok{\# Need to pick a single value for excluded terms due to limitations of mgcv}
  \CommentTok{\# Any value will work. Since the term is excluded, picking a specific value}
  \CommentTok{\# has no effect on the predictions.}
  \AttributeTok{values =} \FunctionTok{c}\NormalTok{(}\AttributeTok{subj =} \StringTok{"s1"}\NormalTok{)}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\pandocbounded{\includegraphics[keepaspectratio]{manuscript_files/figure-pdf/fig-gam-2-preds-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{manuscript_files/figure-pdf/fig-gam-2-preds-t-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{manuscript_files/figure-pdf/fig-dat2-1.pdf}}
...
\NormalTok{gam\_3\_preds }\OtherTok{\textless{}{-}} \FunctionTok{predict\_gam}\NormalTok{(gam\_3, }\AttributeTok{exclude\_terms =} \StringTok{"s(timep,subj)"}\NormalTok{, }\AttributeTok{values =} \FunctionTok{c}\NormalTok{(}\AttributeTok{subj =} \StringTok{"es\_3"}\NormalTok{))}
...
\begin{verbatim}
# A tibble: 99 x 7
   group_vowel timep subj       eud     se lower_ci[,1] upper_ci[,1]
   <fct>       <dbl> <fct>    <dbl>  <dbl>        <dbl>        <dbl>
 1 es.i          1   es_3   2.32    0.0246       2.28         2.37  
 2 es.u          1   es_3   2.02    0.0246       1.97         2.07  
 3 es.a          1   es_3   1.53    0.0246       1.48         1.58  
 4 es_0.i        1   es_3   0.0930  0.0274       0.0394       0.147 
 5 es_0.u        1   es_3   0.154   0.0275       0.100        0.208 
 6 es_0.a        1   es_3  -0.00855 0.0246      -0.0568       0.0397
 7 es_1.i        1   es_3   1.10    0.0272       1.04         1.15  
 8 es_1.u        1   es_3   1.45    0.0261       1.39         1.50  
 9 es_1.a        1   es_3   1.28    0.0246       1.23         1.33  
10 es.i          1.8 es_3   2.32    0.0241       2.28         2.37  
# i 89 more rows
\end{verbatim}
...
\NormalTok{  gam\_3,}
  ...
  \AttributeTok{values =} \FunctionTok{c}\NormalTok{(}\AttributeTok{subj =} \StringTok{"es\_1"}\NormalTok{),}
...
\begin{verbatim}
# A tibble: 234 x 8
   group vowel timep subj       eud     se lower_ci[,1] upper_ci[,1]
   <chr> <chr> <dbl> <fct>    <dbl>  <dbl>        <dbl>        <dbl>
 1 es    i      1    es_1   2.32    0.0246       2.28         2.37  
 2 es    u      1    es_1   2.02    0.0246       1.97         2.07  
 3 es    a      1    es_1   1.53    0.0246       1.48         1.58  
 4 es_0  i      1    es_1   0.0930  0.0274       0.0394       0.147 
 5 es_0  u      1    es_1   0.154   0.0275       0.100        0.208 
 6 es_0  a      1    es_1  -0.00855 0.0246      -0.0568       0.0397
 7 es_1  i      1    es_1   1.10    0.0272       1.04         1.15  
 8 es_1  u      1    es_1   1.45    0.0261       1.39         1.50  
 9 es_1  a      1    es_1   1.28    0.0246       1.23         1.33  
10 es    i      1.32 es_1   2.32    0.0244       2.28         2.37  
# i 224 more rows
\end{verbatim}
...
\pandocbounded{\includegraphics[keepaspectratio]{manuscript_files/figure-pdf/fig-gam-3-1.pdf}}
