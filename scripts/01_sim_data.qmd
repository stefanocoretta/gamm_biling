...
subj_int <- rnorm(subjs, 0, 0.15)
subj_slo <- rnorm(subj, 0, 0.25)
...
for (rown in 1:nrow(dat2_grid)) {
  ...
  if (this_group == "es") {
    if (this_vowel == "i") {
      this_eud <- rep(2.25 + subj_int[this_subj], 9)
    } else if (this_vowel == "u") {
      this_eud <- rep(2 + subj_int[this_subj], 9)
    } else if (this_vowel == "a") {
      this_eud <- rep(1.5 + subj_int[this_subj], 9)
    }
    
    
  } else if (this_group == "es_0") {
    if (this_vowel == "i") {
      this_eud <- 2 + (-0.3 + subj_int[this_subj] - 2)/(1 + (1:timep/2)^(2.5 + subj_slo[this_subj] * 2))
    } else if (this_vowel == "u") {
      this_eud <- 1.6 + (-4 + subj_int[this_subj] - 1.6)/(1 + (1:timep/0.5)^(1.5 + subj_slo[this_subj]))
    } else if (this_vowel == "a") {
      this_eud <- rep(0 + subj_int[this_subj], 9)
    }
    
    
  } else if (this_group == "es_1") {
    if (this_vowel == "i") {
      this_eud <- 2 + (0.9 + subj_int[this_subj] - 2)/(1 + (1:timep/2)^(2.5 + subj_slo[this_subj]))
    } else if (this_vowel == "u") {
      this_eud <- 1.5 + (1 + subj_int[this_subj] - 1.5)/(1 + (1:timep/0.5)^(2.5 + subj_slo[this_subj]))
    } else if (this_vowel == "a") {
      this_eud <- rep(1.25 + subj_int[this_subj], 9)
    }
  }
